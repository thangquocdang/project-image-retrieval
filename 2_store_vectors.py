...
data_folder = "D:/AI Insight Course/Project/Project Image Retrieval/1_crawler/img"
...
data_folder = "D:/AI Insight Course/Project/Project Image Retrieval/1_crawler/img"
for calog in os.listdir(data_folder):
    path_calog = os.path.join(data_folder,calog)
    # Noi full path
    for image_name in os.listdir(path_calog):
        image_path_full = os.path.join(path_calog,image_name)
    # Trich dac trung
